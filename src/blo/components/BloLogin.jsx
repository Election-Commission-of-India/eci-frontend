...
import { bloLogin } from '../services/bloService';
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="bg-white border rounded-lg shadow-sm p-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900">BLO Login</h2>
            <p className="text-sm text-gray-600 mt-2">Booth Level Officer Portal</p>
          </div>
