...
const CommplaintSuccessModal = ({ isOpen, onClose, applicationNumber }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 animate-scale-in">
        ...
        <p className="text-gray-600 text-center text-sm mb-6">
          Your application has been submitted. You'll receive updates via SMS
          and email.
        </p>
...
export default CommplaintSuccessModal;
